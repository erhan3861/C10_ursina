...
class Platform(Button):
    def __init__(self, position=Vec3(0)):
        ...
        # nesnenin kodları, hareket edebilirfrom ursina import * özelliği
...
def input(key):
    if key == 'left mouse down':
            dir = camera.forward + Vec3(0,0.2,0) 
            pos = player.position + player.forward + Vec3(0,2,0)
