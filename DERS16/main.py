...
def input(key):
    ...
    #MARK:send
    # elif key == "left mouse up" and user == "f":
    #     try:
    #         x,y,z = click_position # mouse.world_point

    #         # client side ball movement
    #         peer.send(peer.get_connections()[0], f"pos:{x},{y},{z}".encode("utf-8"))

    #         # hosting side ball movement
    #         click_position = mouse.world_point
    #         shoot() 
